...
const UserTypeCard = ({
  ...
  <div
    onClick={onClick}
    className={`relative p-8 border-2 rounded-2xl cursor-pointer transition-all duration-300 ease-in-out transform hover:-translate-y-2 ${
      isSelected
        ? "border-[#daa520] bg-black shadow-2xl shadow-[#daa520]/20"
  ...
  >
    <div className="flex flex-col items-center text-center">
      <Icon
        className={`h-12 w-12 mb-4 transition-colors duration-300 ${
          isSelected ? "text-[#daa520]" : "text-gray-500"
        }`}
      />
    ...
    {isSelected && (
      <div className="absolute top-4 right-4 h-5 w-5 bg-[#daa520] rounded-full border-2 border-black" />
    )}
  </div>
);
  ...
  const renderRegisterView = () => {
        ...
        <div className="animate-fade-in-down">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <UserTypeCard
              icon={User}
              title="Sou Cliente"
              description="Quero encontrar e agendar serviços com os melhores profissionais."
              isSelected={formData.userType === "client"}
              onClick={() =>
            ...
            <UserTypeCard
              ...
              description="Quero gerenciar minha agenda, serviços e clientes na plataforma."
              isSelected={formData.userType === "serviceProvider"}
              onClick={() =>
                setFormData((prev) => ({
                  ...prev,
    ...
    return (
      <div className="animate-fade-in-up">
        <button
          onClick={() => setFormData((prev) => ({ ...prev, userType: null }))}
          className="flex items-center text-sm text-gray-400 hover:text-[#daa520] mb-6"
        >
        ...
        <h2 className="text-3xl font-bold text-white text-center mb-2">
          Crie a sua conta de{" "}
          {formData.userType === "client" ? "Cliente" : "Profissional"}
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            <Lock className="w-5 h-5 text-gray-400 absolute top-1/2 left-3 transform -translate-y-1/2" />
            <input
              type="password"
              name="password"
              placeholder="Senha"
            ...
            <>
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg p-3 pl-10"
                />
              </div>
              <div className="relative">
                ...
                />
                {phoneError && (
                  <p className="text-red-500 text-xs mt-1 absolute bottom-[-20px] left-0">
                    {phoneError}
                  </p>
                )}
              </div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg p-3 pl-4 appearance-none focus:ring-2 focus:ring-[#daa520]"
                >
          ...
          <h3 className="text-lg font-semibold text-[#daa520] col-span-full pt-4 border-t border-gray-700">
            Endereço
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="relative sm:col-span-2">
              ...
              />
              {cepLoading && (
                <p className="text-xs text-yellow-400 mt-1">Buscando...</p>
              )}
              {cepError && (
          ...
          <button
            type="submit"
            disabled={isLoading || !!cepError || !!phoneError || !!cnpjError}
            className="w-full bg-[#daa520] text-black font-bold py-3 rounded-lg hover:bg-[#c8961e] transition-colors disabled:bg-gray-600"
          >
    ...
    <div className="relative min-h-screen bg-black text-white flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-lg mx-auto">
        <div className="text-center mb-8">
          <Link to="/">
            <img className="w-32 mx-auto" src={logo} alt="Stylo Logo" />
          </Link>
        </div>
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl shadow-black/50">
          ...
          {authError && (
            <p className="text-red-500 text-sm text-center mt-4">{authError}</p>
          )}
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-gray-800 border border-gray-700 text-white font-bold py-3 rounded-lg hover:bg-gray-700 transition-colors disabled:bg-gray-600"
          >
            <svg className="w-5 h-5" viewBox="0 0 48 48">
              ...
              <path
                fill="#4CAF50"
                d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.211 35.091 26.715 36 24 36c-5.223 0-9.641-3.657-11.303-8.591l-6.571 4.819C9.656 39.663 16.318 44 24 44z"
              ></path>
              <path
                fill="#1976D2"
          ...
          <p className="text-center text-sm text-gray-400 mt-8">
            ...
            <button
              ...
              className="font-bold text-[#daa520] hover:underline ml-2"
            >
