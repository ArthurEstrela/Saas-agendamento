 ...
 */
export const getExpenses = async (serviceProviderId: string): Promise<Expense[]> => {
    try {
        // --- CORREÇÃO AQUI ---
 ...
 */
export const addExpense = async (serviceProviderId: string, expenseData: Omit<Expense, 'id' | 'serviceProviderId'>): Promise<string> => {
    try {
        // --- CORREÇÃO AQUI ---
        const expensesColPath = `users/${serviceProviderId}/expenses`;
 ...
 */
export const deleteExpense = async (serviceProviderId: string, expenseId: string): Promise<void> => {
    try {
        // --- CORREÇÃO AQUI ---
