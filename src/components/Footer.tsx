...
const Footer = () => {
  ...
  return (
    // FIX: Adicionado 'relative z-50' para garantir que o footer fique acima dos gradientes da Home
    <footer className="bg-[#18181b] border-t border-[#daa520]/10 relative z-50">
              ...
              <ul className="mt-4 space-y-3">
                ...
                <li>
                  <a
                    ...
                    className="text-base text-gray-400 hover:text-[#daa520] transition-colors break-all"
                  >
        ...
        <div className="mt-16 pt-8 border-t border-[#daa520]/10 flex flex-col sm:flex-row items-center justify-between">
          ...
          <div className="flex items-center space-x-5 mt-4 sm:mt-0">
            {[
              ...
              {
                icon: <InstagramIcon />,
                url: "https://www.instagram.com/stylo_agenda/",
              },
              {
                icon: <TikTokIcon />,
                url: "https://www.tiktok.com/@styloagenda",
              },
            ].map((social, index) => (
              <a
                key={index}
