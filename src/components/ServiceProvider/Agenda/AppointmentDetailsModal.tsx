...
import { useState } from "react"; // Estava faltando
...
export const AppointmentDetailsModal = () => {
  // Corrigido: Adicionado updateStatus e status
  const { selectedAppointment, setSelectedAppointment, updateStatus } =
  ...
  // Corrigido: Extraindo o status do agendamento
  const {
    client,
    services,
    startTime,
  ...
  // Corrigido: A função updateStatus agora vem da store
  ...
  // Condicional para exibir os botões de ação
  const canTakeAction = status === "pending" || status === "scheduled";
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-4">
                {/* ... (resto do corpo do modal, que já está correto) ... */}
              ...
              {canTakeAction && (
                <footer className="p-4 bg-gray-900/50 flex gap-3">
                  ...
                  <button
                    onClick={() => setCancelModalOpen(true)} // Corrigido
