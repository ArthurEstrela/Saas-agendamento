...
import { TrendingUp, TrendingDown, DollarSign, PlusCircle, Edit, Trash2 } from 'lucide-react';
            ...
            <div className="bg-gray-900/80 p-8 rounded-2xl w-full max-w-lg border border-[#daa520]/30 shadow-2xl shadow-[#daa520]/10">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-4 pt-4">
                        ...
                        <button type="submit" className="bg-green-600 hover:bg-green-500 font-semibold px-6 py-2 rounded-lg transition-colors">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
