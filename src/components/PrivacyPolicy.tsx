          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <Section title="7. Contato" icon={Mail} delay={0.7}>
              ...
              <div className="mt-4 p-4 bg-gray-800 rounded-lg inline-block border border-gray-700">
                <a href="mailto:privacidade@stylo.com" className="text-amber-500 font-bold hover:text-amber-400 hover:underline flex items-center gap-2">
                  <Mail size={18} /> privacidade@stylo.com
                </a>
              </div>
            </Section>
