...
export const DateTimeSelection = () => {
    // Usando os nomes corretos da sua store
    const { date: selectedDate, timeSlot: selectedTime, selectDateTime, goToNextStep, goToPreviousStep } = useBookingProcessStore();
    ...
    useEffect(() => {
        if (date) {
            ...
            setTimeout(() => { // Simula busca de horários
    ...
    const handleConfirm = () => {
        if (date && timeSlot) {
            selectDateTime(date, timeSlot); // Salva a data e hora na store
