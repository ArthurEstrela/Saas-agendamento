      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-sm font-semibold text-white tracking-wider uppercase">Soluções</h3>
              <ul className="mt-4 space-y-3">
                <li><Link to="/#features" className="text-base text-gray-400 hover:text-[#daa520] transition-colors">Funcionalidades</Link></li>
                <li><Link to="/#pricing" className="text-base text-gray-400 hover:text-[#daa520] transition-colors">Preços</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3">
                <li><Link to="/faq" className="text-base text-gray-400 hover:text-[#daa520] transition-colors">FAQ</Link></li>
                <li><a href="mailto:stylo.suporte.agenda@gmail.com" className="text-base text-gray-400 hover:text-[#daa520] transition-colors">Email</a></li>
              </ul>
            </div>
          </div>
        </div>
